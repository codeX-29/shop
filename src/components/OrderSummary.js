...
const OrderSummary = ({ order, onClose }) => {
  ...
  return (
    <div className="order-summary">
      {/* Navbar */}
      <nav className="navbar bg-blue-500 text-white px-6 py-4 flex justify-between items-center rounded mb-6">
        <h1 className="text-xl font-bold">My Shop</h1>
        <div>
          <Link
            to="/cart"
            className="bg-white text-blue-500 font-semibold py-1 px-4 rounded hover:bg-gray-100 transition-colors"
          >
            Cart
          </Link>
        </div>
